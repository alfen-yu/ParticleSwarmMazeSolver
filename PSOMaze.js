...
function setup() {
    ...
    document.getElementById("frame-rate").textContent = "FPS: " + Math.floor(frameRate());
    ...
    newMazeButton.position(BUTTON_X_POSITION, BUTTON_Y_POSITIONS[0]);
    ...
    startButton.position(BUTTON_X_POSITION, BUTTON_Y_POSITIONS[1]);
    startButton.elt.addEventListener('click', startMaze);
    styleButton(startButton);

    // Create the "Pause" button
    pauseButton = createButton("Pause the Maze");
    pauseButton.position(BUTTON_X_POSITION, BUTTON_Y_POSITIONS[2]);
    ...
    resetButton.position(BUTTON_X_POSITION, BUTTON_Y_POSITIONS[3]);
    ...
    particleSlider = createSlider(PARTICLE_MIN, PARTICLE_MAX, noOfParticles, PARTICLE_STEP);
    noOfParticles = particleSlider.value();
    particleSlider.position(SLIDER_X_POSITION, 200);
    ...
    speedSlider = createSlider(SPEED_MIN, SPEED_MAX, speed, SPEED_STEP);
    speed = speedSlider.value();
    speedSlider.position(SLIDER_X_POSITION, 250);
...
// THE FOLLOWING FUNCTIONS ARE FOR THE START, STOP, AND RESET BUTTONS 
